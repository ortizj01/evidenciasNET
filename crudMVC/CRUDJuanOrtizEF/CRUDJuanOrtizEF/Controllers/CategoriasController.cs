...
namespace CRUDJuanOrtizEF.Controllers
{
    public class CategoriasController : Controller
    {
        ...
        public CategoriasController(EvaluacionContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index(string buscar, string filtro)
        {
            ...
            // Ordena las categorías según el filtro proporcionado
            switch (filtro)
            {
                ...
                case "NombreDescendente":
                    ...
                    break;
                default:
                    // Por defecto, ordena de forma descendente por el nombre de la categoría
                    categorias = categorias.OrderByDescending(c => c.Nombre);
                    break;
            }
